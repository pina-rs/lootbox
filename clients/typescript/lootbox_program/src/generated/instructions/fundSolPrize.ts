...
export const FUND_SOL_PRIZE_DISCRIMINATOR2 = 0;

export function getFundSolPrizeDiscriminator2Bytes(): ReadonlyUint8Array { return getU8Encoder().encode(FUND_SOL_PRIZE_DISCRIMINATOR2); }
...
export function getFundSolPrizeInstructionDataDecoder(): FixedSizeDecoder<FundSolPrizeInstructionData> {
    return getStructDecoder([['discriminator', getPinaPodDiscriminatorDecoder(FUND_SOL_PRIZE_DISCRIMINATOR, getU8Decoder())], ['migrationVersion', getPinaPodMigrationVersionDecoder(0, getU8Decoder())], ['lamportsPerWin', getU64Decoder()]]);
}
...
export function getFundSolPrizeInstruction<TAccountAuthority extends InstructionSignerInput, TAccountTemplate extends InstructionAccountInput, TAccountBundle extends InstructionAccountInput, TAccountSystemProgram extends InstructionAccountInput, TProgramAddress extends Address = typeof LOOTBOX_PROGRAM_PROGRAM_ADDRESS>(input: FundSolPrizeInput<TAccountAuthority, TAccountTemplate, TAccountBundle, TAccountSystemProgram>, config?: { programAddress?: TProgramAddress } ): FundSolPrizeInstruction<TProgramAddress, ResolvedInstructionAccountMeta<TAccountAuthority, InstructionAccountInputAddress<TAccountAuthority>>, ResolvedInstructionAccountMeta<TAccountTemplate, InstructionAccountInputAddress<TAccountTemplate>>, ResolvedInstructionAccountMeta<TAccountBundle, InstructionAccountInputAddress<TAccountBundle>>, ResolvedInstructionAccountMeta<TAccountSystemProgram, InstructionAccountInputAddress<TAccountSystemProgram>>> {
  // Program address.
...
return Object.freeze({ accounts: [getAccountMeta("authority", accounts.authority), getAccountMeta("template", accounts.template), getAccountMeta("bundle", accounts.bundle), getAccountMeta("systemProgram", accounts.systemProgram)], data: getFundSolPrizeInstructionDataEncoder().encode(args as FundSolPrizeInstructionDataArgs), programAddress } as FundSolPrizeInstruction<TProgramAddress, ResolvedInstructionAccountMeta<TAccountAuthority, InstructionAccountInputAddress<TAccountAuthority>>, ResolvedInstructionAccountMeta<TAccountTemplate, InstructionAccountInputAddress<TAccountTemplate>>, ResolvedInstructionAccountMeta<TAccountBundle, InstructionAccountInputAddress<TAccountBundle>>, ResolvedInstructionAccountMeta<TAccountSystemProgram, InstructionAccountInputAddress<TAccountSystemProgram>>>);
}
