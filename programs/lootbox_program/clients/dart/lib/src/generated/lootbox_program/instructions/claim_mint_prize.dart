...
class ClaimMintPrizeInstructionData {
  const ClaimMintPrizeInstructionData({required this.assetIndex})
    : discriminator = 42;
...
Encoder<ClaimMintPrizeInstructionData>
getClaimMintPrizeInstructionDataEncoder() {
...
Decoder<ClaimMintPrizeInstructionData>
getClaimMintPrizeInstructionDataDecoder() {
  ...
  (ClaimMintPrizeInstructionData, int) readTopLevel(
    Uint8List bytes,
    int offset,
  ) {
    getConstantDecoder(getU8Encoder().encode(42)).read(bytes, offset + 0);
    ...
    return (
      ClaimMintPrizeInstructionData(assetIndex: map['assetIndex']! as int),
      newOffset,
    );
  }
...
Codec<ClaimMintPrizeInstructionData, ClaimMintPrizeInstructionData>
getClaimMintPrizeInstructionDataCodec() {
  return combineCodec(
    getClaimMintPrizeInstructionDataEncoder(),
    getClaimMintPrizeInstructionDataDecoder(),
  );
...
Instruction getClaimMintPrizeInstruction({
  ...
  final instructionData = ClaimMintPrizeInstructionData(assetIndex: assetIndex);
...
ClaimMintPrizeInstructionData parseClaimMintPrizeInstruction(
