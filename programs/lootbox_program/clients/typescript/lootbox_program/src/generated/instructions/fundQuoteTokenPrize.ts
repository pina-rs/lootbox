...
export const FUND_QUOTE_TOKEN_PRIZE_DISCRIMINATOR2 = 0;

export function getFundQuoteTokenPrizeDiscriminator2Bytes(): ReadonlyUint8Array { return getU8Encoder().encode(FUND_QUOTE_TOKEN_PRIZE_DISCRIMINATOR2); }
...
export function getFundQuoteTokenPrizeInstructionDataDecoder(): FixedSizeDecoder<FundQuoteTokenPrizeInstructionData> {
    return getStructDecoder([['discriminator', getPinaPodDiscriminatorDecoder(FUND_QUOTE_TOKEN_PRIZE_DISCRIMINATOR, getU8Decoder())], ['migrationVersion', getPinaPodMigrationVersionDecoder(0, getU8Decoder())], ['amountPerWin', getU64Decoder()]]);
}
