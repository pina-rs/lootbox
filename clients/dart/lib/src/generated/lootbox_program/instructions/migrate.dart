...
import '../programs/lootbox_program.dart' show lootboxProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  Address? lootboxState,
  Address? vaultState,
  Address? openingState,
  Address? templateState,
  Address? bundleState,
  Address? templateOpeningState,
  ...
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: vaultState ?? resolvedProgram,
      role: vaultState == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
      address: openingState ?? resolvedProgram,
      role: openingState == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
      address: templateState ?? resolvedProgram,
      role: templateState == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
      address: bundleState ?? resolvedProgram,
      role: bundleState == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
    ...
    AccountMeta(
      address: prizePoolState ?? resolvedProgram,
      role: prizePoolState == null
          ? AccountRole.readonly
          : AccountRole.writable,
    ),
    AccountMeta(
      address: prizePoolItemState ?? resolvedProgram,
      role: prizePoolItemState == null
          ? AccountRole.readonly
          : AccountRole.writable,
    ),
    AccountMeta(
