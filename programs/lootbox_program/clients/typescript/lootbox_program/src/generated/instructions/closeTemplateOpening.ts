...
const getNextAccount = () => {
  ...
  return { programAddress: instruction.programAddress, accounts: { recipient: getNextAccount(), template: getNextAccount(), opening: getNextAccount(), randomness: getNextAccount(), rewardEscrow: getNextAccount(), oracleProgram: getNextAccount(), oracleProgramState: getNextAccount(), oracleLut: getNextAccount(), oracleLutSigner: getNextAccount(), systemProgram: getNextAccount(), tokenProgram: getNextAccount(), wrappedSolMint: getNextAccount(), addressLookupTableProgram: getNextAccount() }, data: getCloseTemplateOpeningInstructionDataDecoder().decode(instruction.data) };
}