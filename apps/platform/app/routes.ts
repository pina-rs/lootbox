...
export default [
	...
	route("x/:collection/:file", "routes/exclusive-asset.ts"),
	...prefix("api", [
		...
		route("prices", "routes/api.prices.ts"),
		route("admission", "routes/api.admission.ts"),
		route("swap", "routes/api.swap.ts"),
