...
export function getCloseOpeningInstructionDataDecoder(): FixedSizeDecoder<CloseOpeningInstructionData> {
    return getStructDecoder([['discriminator', getZeroPodDiscriminatorDecoder(CLOSE_OPENING_DISCRIMINATOR, getU8Decoder())]]);
}
...
return Object.freeze({ accounts: [getAccountMeta("recipient", accounts.recipient), getAccountMeta("lootbox", accounts.lootbox), getAccountMeta("opening", accounts.opening), getAccountMeta("randomness", accounts.randomness), getAccountMeta("rewardEscrow", accounts.rewardEscrow), getAccountMeta("oracleProgram", accounts.oracleProgram), getAccountMeta("oracleProgramState", accounts.oracleProgramState), getAccountMeta("oracleLut", accounts.oracleLut), getAccountMeta("oracleLutSigner", accounts.oracleLutSigner), getAccountMeta("systemProgram", accounts.systemProgram), getAccountMeta("tokenProgram", accounts.tokenProgram), getAccountMeta("wrappedSolMint", accounts.wrappedSolMint), getAccountMeta("addressLookupTableProgram", accounts.addressLookupTableProgram)], data: getCloseOpeningInstructionDataEncoder().encode({}), programAddress } as CloseOpeningInstruction<TProgramAddress, TAccountRecipient, TAccountLootbox, TAccountOpening, TAccountRandomness, TAccountRewardEscrow, TAccountOracleProgram, TAccountOracleProgramState, TAccountOracleLut, TAccountOracleLutSigner, TAccountSystemProgram, TAccountTokenProgram, TAccountWrappedSolMint, TAccountAddressLookupTableProgram>);
}
