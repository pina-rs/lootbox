...
class ClaimSolPrizeInstructionData {
  const ClaimSolPrizeInstructionData({
...
Decoder<ClaimSolPrizeInstructionData> getClaimSolPrizeInstructionDataDecoder() {
  ...
  (ClaimSolPrizeInstructionData, int) readTopLevel(Uint8List bytes, int offset) {
    getConstantDecoder(
...
Codec<ClaimSolPrizeInstructionData, ClaimSolPrizeInstructionData> getClaimSolPrizeInstructionDataCodec() {
...
Instruction getClaimSolPrizeInstruction({
  ...
  final instructionData = ClaimSolPrizeInstructionData(
...
ClaimSolPrizeInstructionData parseClaimSolPrizeInstruction(Instruction instruction) {
