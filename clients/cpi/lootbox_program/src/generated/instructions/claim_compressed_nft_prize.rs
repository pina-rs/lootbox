...
pub struct ClaimCompressedNftPrize<'account> {
	...
	/// Instruction arguments encoded and sent as CPI data for `claim_compressed_nft_prize`.
	pub ix: ClaimCompressedNftPrizeIx,
}

/// Instruction arguments for the `claim_compressed_nft_prize` CPI call.
#[derive(Clone, Copy, Debug)]
...
impl ClaimCompressedNftPrizeIx {
	...
	pub fn to_bytes(&self) -> Result<[u8; 111], ProgramError> {
		...
		data[..2].copy_from_slice(&CLAIM_COMPRESSED_NFT_PRIZE_DISCRIMINATOR);
...
impl<'account> ClaimCompressedNftPrize<'account> {
...
const CLAIM_COMPRESSED_NFT_PRIZE_DISCRIMINATOR: [u8; 2] = [34, 0];
