...
impl ClosePrizePool {
	...
	pub fn instruction(&self, data: ClosePrizePoolInstructionData) -> solana_instruction::Instruction {
...
impl ClosePrizePoolInstructionData {
	pub fn new(configure: impl FnOnce(&mut ClosePrizePoolInstructionWireZc)) -> Result<Self, solana_program_error::ProgramError> {
