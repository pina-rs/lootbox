...
class ClaimMetadataNftPrizeInstructionData {
  const ClaimMetadataNftPrizeInstructionData({required this.assetIndex})
    : discriminator = 28;
...
Encoder<ClaimMetadataNftPrizeInstructionData>
getClaimMetadataNftPrizeInstructionDataEncoder() {
...
Decoder<ClaimMetadataNftPrizeInstructionData>
getClaimMetadataNftPrizeInstructionDataDecoder() {
  ...
  (ClaimMetadataNftPrizeInstructionData, int) readTopLevel(
    Uint8List bytes,
    int offset,
  ) {
    getConstantDecoder(getU8Encoder().encode(28)).read(bytes, offset + 0);
...
Codec<
  ...
  ClaimMetadataNftPrizeInstructionData
>
getClaimMetadataNftPrizeInstructionDataCodec() {
  return combineCodec(
    getClaimMetadataNftPrizeInstructionDataEncoder(),
    getClaimMetadataNftPrizeInstructionDataDecoder(),
  );
...
Instruction getClaimMetadataNftPrizeInstruction({
  ...
  return Instruction(
    ...
    data: getClaimMetadataNftPrizeInstructionDataEncoder().encode(
      instructionData,
    ),
  );
}
...
ClaimMetadataNftPrizeInstructionData parseClaimMetadataNftPrizeInstruction(
  Instruction instruction,
) {
  return getClaimMetadataNftPrizeInstructionDataDecoder().decode(
    instruction.data!,
  );
}
