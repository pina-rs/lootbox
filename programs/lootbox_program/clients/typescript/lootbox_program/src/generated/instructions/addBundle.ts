...
export type AddBundleInput<TAccountAuthority extends string = string, TAccountTemplate extends string = string, TAccountBundle extends string = string, TAccountSystemProgram extends string = string> =  {
...
export function getAddBundleInstruction<TAccountAuthority extends string, TAccountTemplate extends string, TAccountBundle extends string, TAccountSystemProgram extends string, TProgramAddress extends Address = typeof LOOTBOX_PROGRAM_PROGRAM_ADDRESS>(input: AddBundleInput<TAccountAuthority, TAccountTemplate, TAccountBundle, TAccountSystemProgram>, config?: { programAddress?: TProgramAddress } ): AddBundleInstruction<TProgramAddress, TAccountAuthority, TAccountTemplate, TAccountBundle, TAccountSystemProgram> {
  // Program address.
