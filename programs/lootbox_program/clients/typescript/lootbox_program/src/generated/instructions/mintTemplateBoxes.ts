...
export const MINT_TEMPLATE_BOXES_DISCRIMINATOR2 = 0;
...
export function getMintTemplateBoxesInstructionDataDecoder(): FixedSizeDecoder<MintTemplateBoxesInstructionData> {
    return getStructDecoder([['discriminator', getPinaPodDiscriminatorDecoder(MINT_TEMPLATE_BOXES_DISCRIMINATOR, getU8Decoder())], ['migrationVersion', getPinaPodMigrationVersionDecoder(0, getU8Decoder())], ['amount', getU64Decoder()]]);
}
